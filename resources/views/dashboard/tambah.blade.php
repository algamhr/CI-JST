            ...
            <div class="mdc-layout-grid__inner">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        <h6 class="card-title card-padding pb-0">Tambah Data Cuaca</h6>
                        <div class="table-responsive">
                            <form action="/dashboard/update/{{$weather->id}}" method="POST">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>Suhu</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            {{ csrf_field() }}
                                            <td><input class="input" type="text" name="temp" value="{{$weather->temp}}">
                                            </td>
                                            <td><input class="input" type="text" name="hum" value="{{$weather->hum}}">
                                            </td>
                                            <td><input class="input" type="text" name="windspeed"
                                                    value="{{$weather->windspeed}}"></td>
                                            <td><input class="input" type="text" name="weathersit"
                                                    value="{{$weather->weathersit}}"></td>
